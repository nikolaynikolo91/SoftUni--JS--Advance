class Kitchen {
  ...
  addToMenu(meal, neededIngs, price) {
    ...
    if (!this.menu[meal]) {
      ...
      } meals on the menu, other ideas?`; //? no effect //TEST 6 ERROR
    } else
      return `The ${meal} is already in our menu, try something different.`; //test 7 - pass
  }
  showTheMenu() {
    let toPrint = [];
